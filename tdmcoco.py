...
# Directory to save model and model checkpoints, if not provided
# through the command line argument --model
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "model")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', required=False,
                        ...
                        help='Logs and checkpoints directory (default=model/)')
